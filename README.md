...
Освен гражданско-значимите ремонти, `Докога?` вече анализира **обществените поръчки на национално ниво** за обективни сигнали за интегритетен риск, върху отворени CC0 данни (ЦАИС ЕОП + Търговски регистър). Видимо е в страницата **Анализи** (`/analytics`) и през `/integrity` API.
...
| `GET` | `/integrity/top-risk` · `/integrity/network` | Най-рискови договори · обща собственост |
